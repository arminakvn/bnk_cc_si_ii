log using main_Jun20.log, replace
...
*** FIG 2 COMPARE VERY POOR WHITE TO NONPOOR MINORITY NEIGHBORHOODS ****
* CAR and FOOT
foreach mode in cr ft {
xtlogit aclsr_`mode' wht15 blc15 lat15 asi15 oth15 pov15 frn15 ppdnl15 edu15 ump15 own15  hu15sqk vacrat15 blb00 cmdnpcpt, re vce(robust) nocons
****** FOR POV=10
* For poor and  wht = 50, 70, 90
margins, atmeans at(pov15=50 wht15=50 blc15=20 lat15=20 asi15=8 oth15=2 (p75)ump15 (p25)edu15 (p25)own15) at(pov15=50 wht15=70 blc15=10 lat15=10 asi15=8 oth15=2 (p75)ump15 (p25)edu15 (p25)own15) at(pov15=50 wht15=90 blc15=0 lat15=0 asi15=8 oth15=2 (p75)ump15 (p25)edu15 (p25)own15) 
* For nonpoor blc = 50, 70, 90
margins, atmeans at(pov15=10 blc15=50 wht15=20 lat15=20 asi15=8 oth15=2 (p25)ump15 (p75)edu15 (p75)own15) at(pov15=10 blc15=70 wht15=10 lat15=10 asi15=8 oth15=2 (p25)ump15 (p75)edu15 (p75)own15) at(pov15=10 blc15=90 wht15=0 lat15=0 asi15=8 oth15=2 (p25)ump15 (p75)edu15 (p75)own15)
* For nonpoor lat = 50, 70, 90
margins, atmeans at(pov15=10 lat15=50 wht15=20 blc15=20 asi15=8 oth15=2 (p25)ump15 (p75)edu15 (p75)own15) at(pov15=10 lat15=70 wht15=10 blc15=10 asi15=8 oth15=2 (p25)ump15 (p75)edu15 (p75)own15) at(pov15=10 lat15=90 wht15=0 blc15=0 asi15=8 oth15=2 (p25)ump15 (p75)edu15 (p75)own15)
 }
 * PUBLIC TRANSIT after excluding Memphis, due to data issues
 xtlogit aclsr_pt wht15 blc15 lat15 asi15 oth15 pov15 frn15 ppdnl15 edu15 ump15 own15  hu15sqk vacrat15 blb00 cmdnpcpt if cityname~="memphis", re vce(robust) nocons
* For poor and  wht = 50, 70, 90
